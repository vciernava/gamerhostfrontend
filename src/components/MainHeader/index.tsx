          ...
          <div className="flex h-[700px] items-center overflow-hidden">
            ...
            <div className="relative hidden h-full xl:block xl:w-[65%]">
              <div
                ...
                id="blocks1"
              >
                <div className="relative top-6 z-[1] h-10 w-10 animate-[floatRotateX_5s_ease-in-out_infinite] rounded-md bg-primary-700/40 backdrop-blur-sm"></div>
                <div className="relative left-4 top-3 z-0 h-12 w-12 animate-[floatRotateX_4s_ease-in-out_infinite] rounded-md bg-primary-700/40 backdrop-blur-sm"></div>
                <div className="relative left-6 top-1 -z-[1] h-14 w-14 animate-[floatRotateX_6s_ease-in-out_infinite] rounded-md bg-primary-700/40 backdrop-blur-sm"></div>
              </div>
              <div
                className="absolute bottom-[30%] left-[25%] z-10 rotate-[160deg]"
                id="blocks2"
              >
                <div className="relative top-6 z-[1] h-10 w-10 animate-[floatRotateY_5s_ease-in-out_infinite] rounded-md bg-primary-700/40 backdrop-blur-sm"></div>
                <div className="relative left-4 top-3 z-0 h-12 w-12 animate-[floatRotateY_4s_ease-in-out_infinite] rounded-md bg-primary-700/40 backdrop-blur-sm"></div>
                <div className="relative left-6 top-1 -z-[1] h-14 w-14 animate-[floatRotateY_6s_ease-in-out_infinite] rounded-md bg-primary-700/40 backdrop-blur-sm"></div>
              </div>
              ...
              <PrimaryButton className="absolute bottom-[20%] left-1/2 w-2/4 -translate-x-1/2 rounded-md bg-primary-700/60 py-4 text-center text-white backdrop-blur-sm hover:scale-110 hover:bg-primary-700">
                {Post.title}
              </PrimaryButton>
            </div>
          </div>
